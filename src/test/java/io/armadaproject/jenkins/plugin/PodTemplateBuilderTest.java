...
import static io.armadaproject.jenkins.plugin.PodTemplateBuilder.*;
import static io.armadaproject.jenkins.plugin.PodTemplateUtils.*;
...
public class PodTemplateBuilderTest {
    ...
    public void namespaceFromCloud() {
        when(cloud.getArmadaNamespace()).thenReturn("cloud-namespace");
        PodTemplate template = new PodTemplate();
        Pod pod = new PodTemplateBuilder(template, slave).build();
