...
public class ArmadaJobSetManager implements Serializable, ArmadaJobSetEventWatcher.ArmadaMessageCallback {
    ...
    public void cleanupAbandonedJobs(Set<String> agentAssociatedJobIds) {
    ...
    private ArmadaJobMetadata waitUntilState(String jobId, Set<SubmitOuterClass.JobState> states, long timeout, TimeUnit unit) throws InterruptedException, TimeoutException {
        var job = knownJobs.getOrDefault(jobId, null);
        if(job == null) {
