...
public class ArmadaState implements Saveable, Serializable {
    ...
    private synchronized void reconfigure(List<ArmadaCloud> clouds) {
    ...
    protected void runCleanup() {
        var activeAgents = new HashMap<String, List<ArmadaSlave>>();
        ...
        jobManagers.forEach((cloudName, jobManager) -> {
            try {
                if (activeAgents.containsKey(cloudName)) {
                    ...
                    var jobsPerJobSet = new HashMap<String, Set<String>>();
