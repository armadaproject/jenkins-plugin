...
public class ArmadaSlave extends AbstractCloudSlave {
    ...
    protected void _terminate(TaskListener listener) throws IOException, InterruptedException {
        ...
        if (ch != null) {
            ...
            try {
                ...
                //this will shut down the jnlp container
                ch.close();
        ...
        try {
            ...
            if(armadaJobSetId != null && armadaJobId != null) {
                // give the job a chance to exit cleanly
                try {
                    jobManager.waitUntilTerminated(armadaJobSetId, armadaJobId, DISCONNECTION_TIMEOUT * 2L, TimeUnit.SECONDS);
                } catch(Throwable e) {
                    LOGGER.log(Level.INFO, "Error while waiting for job " + armadaJobId + " to terminate cleanly.", e);
                }
    ...
    private void ensureServerInfo() {
        if(this.serverUrl == null) {
            ...
            var clusterData = ArmadaClusterInfoProvider.resolveClusterInfo(getArmadaCloud(), clusterId);
    ...
    public static class Builder {
        ...
        private static RetentionStrategy determineRetentionStrategy(
                @NonNull ArmadaCloud cloud, @NonNull PodTemplate podTemplate) {
